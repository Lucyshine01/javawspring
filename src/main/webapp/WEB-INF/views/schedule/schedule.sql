...
select * from schedule2 where mid='hkd1234' and sDate like '%2023-01%' order by sDate;
select * from schedule2 where mid='hkd1234' and substring(sDate,1,7) = '2023-01' order by sDate;
select * from schedule2 where mid='hkd1234' and date_format(sDate, '%Y-%m')='2023-01' order by sDate; /* 날짜포맷 함수 */
select * from schedule2 where mid='hkd1234' and date_format(sDate, '%Y-%m')='2023-01' group by substring(sDate,1,7) order by sDate; /* 날짜포맷 함수 */
select sDate,count(*) from schedule2 where mid='hkd1234' and date_format(sDate, '%Y-%m')='2023-01' group by substring(sDate,1,7) order by sDate; /* 날짜포맷 함수 */
select sDate,part from schedule2 where mid='hkd1234' and date_format(sDate, '%Y-%m')='2023-01' order by sDate, part; /* 날짜포맷 함수 */
