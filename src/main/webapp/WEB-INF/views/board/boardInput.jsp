...
<div class="container">
  <form name="myform" method="post">
  	...
  	<table class="table">
  		...
  		<tr>
  			<th>홈페이지</th>
  			<td><input type="text" name="homePage" id="homePage" placeholder="홈페이지 주소를 입력하세요" value="${homePage}" class="form-control"/></td>
  		</tr>
  		<tr>
  			<th>글내용</th>
  			...
  			<script>
  				CKEDITOR.replace("content",{
  					height:500,
  					filebrowserUploadUrl:"${ctp}/imageUpload", /* 그림 업로드 브라우저 예약어 */
  					uploadUrl:"${ctp}/imageUpload"  /* 그림을 드래그해서 업로드가능하게하는 예악어 */
  				});
  			</script>
  		</tr>
  		<tr>
  			<td colspan="2" class="text-center">
  				...
  				<input type="button" value="돌아가기"  onclick="location.href='${ctp}/board/boardList?pag=${pag}&pageSize=${pageSize}';" class="btn btn-primary" />
  			</td>
  		</tr>
  	</table>
