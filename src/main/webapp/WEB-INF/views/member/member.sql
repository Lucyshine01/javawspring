...
create table member (
	...
	level int default 1,							/* 회원등급(0:관리자, 1:운영자, 2:우수회원, 3:정회원, 4:준회원) */
...
insert into member2 values (default,'admin','1234','관리맨','관리자',default,default,'010-2880-5451','충청북도 청주시 풍년로 56','saasdfhr@gmail.com','http://www.saasdfhr1234.com','프리랜서','등산/바둑',default,'관리자입니다.',default,default,default,0,default,default,default,default);

select * from member2;

delete from member2 where mid = 'asdfasdf';
update member2 set pwd = '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4'  where mid = 'admin';
