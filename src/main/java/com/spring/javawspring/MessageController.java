...
public class MessageController {
	...
	public String msgget(@PathVariable String msgFlag, Model model,
		...
		if(msgFlag.equals("memberLoginOk")) {
			...
			model.addAttribute("url", "board/boardList?pageSize="+pageVO.getPageSize());
		}
		else if(msgFlag.equals("boardInputNo")) {
			model.addAttribute("msg", "게시글이 등록에 실패했습니다.");
			model.addAttribute("url", "board/boardInput?pag="+pageVO.getPag()+"&pageSize="+pageVO.getPageSize());
		}
			...
			model.addAttribute("url", "board/boardContent"+flag);
		}
